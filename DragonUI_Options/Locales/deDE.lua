...
L["Place category filter tabs on the left side of the bag frame instead of the right."] = "Kategorie-Filter-Tabs auf der linken Seite des nfensters statt rechts platzieren."
...
L["Apply darker tinted textures to all UI chrome: action bars, unit frames, minimap, bags, micro menu, and more."] = "Dunkler getönte Texturen auf alle UI-Elemente anwenden: Aktionsleisten, Einheitenfenster, Minimap, n, Mikromenü und mehr."
L["Apply darker tinted textures to all UI elements."] = "Dunkler getönte Texturen auf alle UI-Elemente anwenden."
L["Darkens UI borders and chrome only: action bar borders, unit frame borders, minimap border, bag slot borders, micro menu, castbar borders, and decorative elements. Icons, portraits, and abilities are never affected."] = "Dunkelt nur UI-Rahmen und Zierleisten ab: Aktionsleisten-Rahmen, Einheitenfenster-Rahmen, Minimap-Rahmen, nplatz-Rahmen, Mikromenü, Zauberbalken-Rahmen und Deko-Elemente. Icons, Porträts und Fähigkeiten sind nicht betroffen."
